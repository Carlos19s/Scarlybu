    ...
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-3xl p-8 shadow-sm mb-8 text-left">
            ...
            <div class="space-y-4 text-zinc-600 dark:text-zinc-300">
                <p class="font-medium text-zinc-800 dark:text-zinc-200">Para reservar tu pedido deposita o puedes hacer el pago físicamente acercándote al local.</p>
                <div class="bg-zinc-50 dark:bg-zinc-800 p-5 rounded-xl border border-zinc-200 dark:border-zinc-700 font-mono text-sm space-y-1.5">
                ...
                <p class="text-sm text-zinc-500 dark:text-zinc-400">Una vez realizado el pago, envíanos el comprobante por WhatsApp adjuntando tu número de pedido (<strong>{{ $order->numero_pedido }}</strong>) o tu Nota de Pedido.</p>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/593991329846?text={{ urlencode('Hola, acabo de realizar el pedido #' . $order->numero_pedido . ' y deseo confirmar mi reserva.') }}" target="_blank"
               class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#25d366] hover:bg-[#20ba5a] text-white font-bold rounded-xl shadow-lg shadow-[#25d366]/20 transition-all hover:scale-105 active:scale-95">
